...
function Pickdate() {
    ...
    return <div className="inside-container col-lg-6 col-12 m-auto">
        ...
        <div className="service-details-ho col-lg-5 col-12 p-3 p-md-4">
            ...
            {/* ck date goes here */}
            <div className="my-2" id="s-details"></div>
